...
.lp_mv	move.l	(a2)+,(a0)+
		...
		cmp.l	mpd_pit_length(a1),d7
		blt.s	.update_offset
		
		; INCORRECT - needs to reset to both source & output loop offsets
		moveq	#1,d6								; Set the reset flag
		moveq	#0,d7								; Reset offset
		move.l	d7,mpd_pit_sample_offset(a1)		; Reset source
