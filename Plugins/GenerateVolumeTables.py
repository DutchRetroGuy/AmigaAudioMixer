# $VER: GenerateVolumeTables 1.1 (25.02.25)
#
...
while level_counter < volume_levels-1:
    ...
    while sample_value < 128:
        volume_table[sample_value] = (sample_value/volume_levels)*(level_counter+1)
        sample_value=sample_value + 1

    # Next the negative numbers
    sample_value = 0
    while sample_value < 128:
        volume_table[sample_value+128] = ((-128+sample_value)/volume_levels)*(level_counter+1)
        sample_value = sample_value + 1
    ...
    while sample_value < 256:
        if sample_value == 0:
            ...
            #    output_string = output_string+"vol_level_"+str(level_counter+1)+"\\1\t\tdc.b "
            #else:
            output_string = output_string+"vol_level_"+str(level_counter+1)+"\\1\tdc.b "
