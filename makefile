...
$(DATADIR)$(SLASH)samples_e8x.o: $(DATADIR)$(SLASH)samples_e8x.asm $(DATADIR)$(SLASH)samples_e8x.i $(MIXERDIR)$(SLASH)mixer.i $(DATADIR)$(SLASH)snap_1.raw $(DATADIR)$(SLASH)snap_2.raw
...
$(DATADIR)$(SLASH)module_e8x.o: $(DATADIR)$(SLASH)module_e8x.asm $(DATADIR)$(SLASH)module_e8x.i $(DATADIR)$(SLASH)SneakyChickE8x.mod $(DATADIR)$(SLASH)SneakyChick.lsbank $(DATADIR)$(SLASH)SneakyChick.lsmusic
