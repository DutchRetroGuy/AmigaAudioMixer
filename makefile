...
$(DATADIR)$(SLASH)samples_e8x.o: $(DATADIR)$(SLASH)samples_e8x.asm $(DATADIR)$(SLASH)samples_e8x.i $(MIXERDIR)$(SLASH)mixer.i $(DATADIR)$(SLASH)E8x_Samples$(SLASH)AMSET-11025_DR_01_BD.raw $(DATADIR)$(SLASH)E8x_Samples$(SLASH)AMSET-11025_DR_02_BD+HH.raw $(DATADIR)$(SLASH)E8x_Samples$(SLASH)AMSET-11025_DR_03_HH.raw $(DATADIR)$(SLASH)E8x_Samples$(SLASH)AMSET-11025_DR_04_BD+SN_TAIL.raw $(DATADIR)$(SLASH)E8x_Samples$(SLASH)AMSET-11025_DR_05_BD_VOL50.raw $(DATADIR)$(SLASH)E8x_Samples$(SLASH)AMSET-11025_DR_06_HH_VOL66.raw
