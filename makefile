...
# Targets
ifeq ($(COMPILE_C),0)
all: housekeeping $(SINGLEMIXER) $(SINGLEMIXERHQ) $(MULTIMIXER) $(PAIRMIXER) $(MINIMALMIXER) $(EXTERNALIRQMIXER) $(PERFTEST) $(CALLBACKEXAMPLE) $(PLUGINEXAMPLE) $(MIXEROBJECTS) $(PLUGINSOBJECTS) housekeeping_cleanup
else
all: housekeeping $(SINGLEMIXER) $(SINGLEMIXERHQ) $(MULTIMIXER) $(PAIRMIXER) $(MINIMALMIXER) $(EXTERNALIRQMIXER) $(PERFTEST) $(CALLBACKEXAMPLE) $(PLUGINEXAMPLE) $(CMIXER) $(COSLEGAL) $(CSAMCONV) $(MIXEROBJECTS) $(PLUGINSOBJECTS) housekeeping_cleanup
endif

mixer: $(MIXEROBJECTS) $(CONVERTER) $(PLUGINSOBJECTS)

ifeq ($(COMPILE_C),0)
install: housekeeping $(SINGLEMIXER) $(SINGLEMIXERHQ) $(MULTIMIXER) $(PAIRMIXER) $(MINIMALMIXER) $(EXTERNALIRQMIXER) $(CALLBACKEXAMPLE) $(PLUGINEXAMPLE) $(PERFTEST) $(MIXEROBJECTS) $(PLUGINSOBJECTS) housekeeping_cleanup
else
install: housekeeping $(SINGLEMIXER) $(SINGLEMIXERHQ) $(MULTIMIXER) $(PAIRMIXER) $(MINIMALMIXER) $(EXTERNALIRQMIXER) $(CALLBACKEXAMPLE) $(PLUGINEXAMPLE) $(PERFTEST) $(CMIXER) $(COSLEGAL) $(CSAMCONV) $(MIXEROBJECTS) $(PLUGINSOBJECTS) housekeeping_cleanup
endif
