...
SINGLEMIXERE8XDIR=$(EXAMPLEDIR)$(SLASH)SingleMixerE8xSource
...
EXTERNALIRQMIXERDIR=$(EXAMPLEDIR)$(SLASH)ExternalIRQSource
...
SINGLEMIXERE8XEXE=SingleMixerE8XExample
SINGLEMIXERE8X=$(EXAMPLEDIR)$(SLASH)$(SINGLEMIXERE8XEXE)
...
EXTERNALIRQEXE=ExternalIRQExample
EXTERNALIRQMIXER=$(EXAMPLEDIR)$(SLASH)$(EXTERNALIRQEXE)
...
INCLUDE_SE8X=-I$(SINGLEMIXERE8XDIR)$(SLASH)Mixer -I$(SINGLEMIXERE8XDIR)$(SLASH)Support -I$(SUPPORTDIR)
...
INCLUDE_EXTERNAL=-I$(EXTERNALIRQMIXERDIR)$(SLASH)Mixer -I$(EXTERNALIRQMIXERDIR)$(SLASH)Support -I$(EXTERNALIRQMIXERDIR)
...
ASMFLAGS_SE8X=$(ASMFLAGS_BASE) $(INCLUDE) $(INCLUDE_SE8X)
...
ASMFLAGS_EXTERNAL=$(ASMFLAGS_BASE) $(INCLUDE) $(INCLUDE_EXTERNAL)
...
DATA_EX8=$(DATADIR)$(SLASH)tiles.o $(DATADIR)$(SLASH)samples.o $(DATADIR)$(SLASH)samples_e8x.o
...
MODDATA_E8X=$(DATADIR)$(SLASH)module_e8x.o
...
SE8XOBJS=$(SINGLEMIXERE8XDIR)$(SLASH)SingleMixerE8x.o $(SINGLEMIXERE8XDIR)$(SLASH)Mixer$(SLASH)mixer.o $(SINGLEMIXERE8XDIR)$(SLASH)Support$(SLASH)strings.o
...
GENOBJECTS_E8X=$(CONVERTER) $(GFX) $(DATA_EX8) $(SUPPORT)
...
SE8XOBJECTS=$(SE8XOBJS) $(PTPLAYER) $(LSPLAYER) $(MODDATA_E8X)
MULTIOBJECTS=$(MULTIOBJS)
PAIROBJECTS=$(PAIROBJS)
MINIMALOBJECTS=$(MINIMALOBJS)
EXTERNALIRQOBJECTS=$(EXTERNALOBJS)
...
housekeeping_cleanup:
	$(RMDIR_MIXER)
	$(RMDIR_PLUGINS)
	$(RM) $(PERFTESTDIR)$(SLASH)Mixer$(SLASH)mixer.asm
	$(RM) $(PERFTESTDIR)$(SLASH)Mixer$(SLASH)mixer.i
	$(RM) $(PERFTESTDIR)$(SLASH)Mixer$(SLASH)mixer.h
	$(RM) $(PERFTESTDIR)$(SLASH)Plugins$(SLASH)plugins.asm
	$(RM) $(PERFTESTDIR)$(SLASH)Plugins$(SLASH)plugins.i
	$(RM) $(PERFTESTDIR)$(SLASH)Plugins$(SLASH)plugins.h	

	
# Targets
ifeq ($(COMPILE_C),0)
all: housekeeping $(SINGLEMIXER) $(SINGLEMIXERHQ) $(SINGLEMIXERE8X) $(MULTIMIXER) $(PAIRMIXER) $(MINIMALMIXER) $(EXTERNALIRQMIXER) $(PERFTEST) $(CALLBACKEXAMPLE) $(PLUGINEXAMPLE) $(MIXEROBJECTS) $(PLUGINSOBJECTS) housekeeping_cleanup
else
all: housekeeping $(SINGLEMIXER) $(SINGLEMIXERHQ) $(SINGLEMIXERE8X) $(MULTIMIXER) $(PAIRMIXER) $(MINIMALMIXER) $(EXTERNALIRQMIXER) $(PERFTEST) $(CALLBACKEXAMPLE) $(PLUGINEXAMPLE) $(CMIXER) $(COSLEGAL) $(CSAMCONV) $(MIXEROBJECTS) $(PLUGINSOBJECTS) housekeeping_cleanup
endif

mixer: $(MIXEROBJECTS) $(CONVERTER) $(PLUGINSOBJECTS)

ifeq ($(COMPILE_C),0)
install: housekeeping $(SINGLEMIXER) $(SINGLEMIXERHQ) $(SINGLEMIXERE8X) $(MULTIMIXER) $(PAIRMIXER) $(MINIMALMIXER) $(EXTERNALIRQMIXER) $(CALLBACKEXAMPLE) $(PLUGINEXAMPLE) $(PERFTEST) $(MIXEROBJECTS) $(PLUGINSOBJECTS) housekeeping_cleanup
else
install: housekeeping $(SINGLEMIXER) $(SINGLEMIXERHQ) $(SINGLEMIXERE8X) $(MULTIMIXER) $(PAIRMIXER) $(MINIMALMIXER) $(EXTERNALIRQMIXER) $(CALLBACKEXAMPLE) $(PLUGINEXAMPLE) $(PERFTEST) $(CMIXER) $(COSLEGAL) $(CSAMCONV) $(MIXEROBJECTS) $(PLUGINSOBJECTS) housekeeping_cleanup
endif
...
clean_internal:
	$(RM) $(SINGLEMIXER) $(SINGLEMIXERHQ) $(SINGLEMIXERE8X) $(MULTIMIXER) $(PAIRMIXER)
	$(RM) $(MINIMALMIXER) $(EXTERNALMIXER) $(CALLBACKEXAMPLE) $(PLUGINEXAMPLE) $(PERFTEST)
	$(RM_CLEAN)
ifeq ($(COMPILE_C),1)
...
show_depend: ASMFLAGS_SE8X=$(ASMFLAGS_BASE) $(INCLUDE) $(INCLUDE_SE8X) -depend=make -quiet
...
show_depend: ASMFLAGS_PLUGIN=$(ASMFLAGS_PLUGIN) $(INCLUDE) $(INCLUDE_PLUGIN) -depend=make -quiet
show_depend: ASMFLAGS_MINIMAL=$(ASMFLAGS_MINIMAL) $(INCLUDE) $(INCLUDE_MINIMAL) -depend=make -quiet
show_depend: ASMFLAGS_EXTERNAL=$(ASMFLAGS_EXTERNAL) $(INCLUDE) $(INCLUDE_EXTERNAL) -depend=make -quiet
...
show_depend: $(GENOBJECTS_E8X)
show_depend: $(MULTIOBJECTS) $(PAIROBJECTS) $(MINIMALOBJECTS) $(CALLBACKOBJECTS) $(PLUGINEXOBJECTS) $(EXTERNALIRQOBJECTS)
...
$(SINGLEMIXERE8X): $(GENOBJECTS_E8X) $(SE8XOBJECTS) $(STARTUPOBJECT)
	$(LNK) $(LNKFLAGS) $(STARTUPOBJECT) $(GENOBJECTS_E8X) $(SE8XOBJECTS) -o $@
...
$(EXTERNALIRQMIXER): $(MINGENOBJECTS) $(EXTERNALIRQOBJECTS)
	$(LNK) $(LNKFLAGS) $(EXTERNALIRQOBJECTS) $(MINGENOBJECTS) -o $@
...
$(DATADIR)$(SLASH)samples_e8x.o: $(DATADIR)$(SLASH)samples_e8x.asm $(DATADIR)$(SLASH)samples_e8x.i $(MIXERDIR)$(SLASH)mixer.i $(DATADIR)$(SLASH)E8x_Samples$(SLASH)AMSET-16574_DR_01_BD.raw $(DATADIR)$(SLASH)E8x_Samples$(SLASH)AMSET-16574_DR_02_BD+HH.raw $(DATADIR)$(SLASH)E8x_Samples$(SLASH)AMSET-16574_DR_03_HH.raw $(DATADIR)$(SLASH)E8x_Samples$(SLASH)AMSET-16574_DR_04_BD+SN_TAIL.raw $(DATADIR)$(SLASH)E8x_Samples$(SLASH)AMSET-16574_DR_05_BD_VOL50.raw $(DATADIR)$(SLASH)E8x_Samples$(SLASH)AMSET-16574_DR_06_HH_VOL66.raw
	$(ASM) $(ASMFLAGS) -DBUILD_SAMPLES_E8X $< -o $@
$(DATADIR)$(SLASH)module.o: $(DATADIR)$(SLASH)module.asm $(DATADIR)$(SLASH)module.i $(DATADIR)$(SLASH)SneakyChick.mod $(DATADIR)$(SLASH)SneakyChick.lsbank $(DATADIR)$(SLASH)SneakyChick.lsmusic
	$(ASM) $(ASMFLAGS) -DBUILD_MOD $< -o $@
$(DATADIR)$(SLASH)module_e8x.o: $(DATADIR)$(SLASH)module_e8x.asm $(DATADIR)$(SLASH)module_e8x.i $(DATADIR)$(SLASH)audiomixer_004.mod $(DATADIR)$(SLASH)SneakyChick.lsbank $(DATADIR)$(SLASH)SneakyChick.lsmusic
	$(ASM) $(ASMFLAGS) -DBUILD_MOD_E8X $< -o $@
...
# SingleMixerHQ objects
$(SINGLEMIXERE8XDIR)$(SLASH)SingleMixerE8x.o: $(SINGLEMIXERE8XDIR)$(SLASH)SingleMixerE8x.asm $(SINGLEMIXERE8XDIR)$(SLASH)SingleMixerE8x.i $(SUPPORTDIR)$(SLASH)debug.i $(GFXDIR)$(SLASH)displaybuffers.i $(GFXDIR)$(SLASH)blitter.i $(GFXDIR)$(SLASH)copperlists.i $(GFXDIR)$(SLASH)font.i $(CONVERTERDIR)$(SLASH)converter.i $(DATADIR)$(SLASH)samples.i $(DATADIR)$(SLASH)samples_e8x.i $(SINGLEMIXERHQDIR)$(SLASH)Mixer$(SLASH)mixer.i $(SINGLEMIXERHQDIR)$(SLASH)Mixer$(SLASH)mixer_config.i
	$(ASM) $(ASMFLAGS_SE8X) -DBUILD_DBUFFERS $< -o $@
$(SINGLEMIXERE8XDIR)$(SLASH)Mixer$(SLASH)mixer.o: $(SINGLEMIXERE8XDIR)$(SLASH)Mixer$(SLASH)mixer.asm $(SINGLEMIXERE8XDIR)$(SLASH)Mixer$(SLASH)mixer.i $(SINGLEMIXERE8XDIR)$(SLASH)Mixer$(SLASH)mixer_config.i
	$(ASM) $(ASMFLAGS_SE8X) -DBUILD_MIXER $< -o $@
$(SINGLEMIXERE8XDIR)$(SLASH)Support$(SLASH)strings.o: $(SINGLEMIXERE8XDIR)$(SLASH)Support$(SLASH)strings.asm $(SINGLEMIXERE8XDIR)$(SLASH)Support$(SLASH)strings.i
	$(ASM) $(ASMFLAGS_SE8X) -DBUILD_STRINGS_SM $< -o $@
...
# ExternalIRQMixer objects
$(EXTERNALIRQMIXERDIR)$(SLASH)ExternalIRQMixer.o: $(EXTERNALIRQMIXERDIR)$(SLASH)ExternalIRQMixer.asm $(SUPPORTDIR)$(SLASH)debug.i $(CONVERTERDIR)$(SLASH)converter.i $(DATADIR)$(SLASH)samples.i $(EXTERNALIRQMIXERDIR)$(SLASH)Mixer$(SLASH)mixer.i $(EXTERNALIRQMIXERDIR)$(SLASH)Mixer$(SLASH)mixer_config.i
	$(ASM) $(ASMFLAGS_MINIMAL) $< -o $@
$(EXTERNALIRQMIXERDIR)$(SLASH)Mixer$(SLASH)mixer.o: $(EXTERNALIRQMIXERDIR)$(SLASH)Mixer$(SLASH)mixer.asm $(EXTERNALIRQMIXERDIR)$(SLASH)Mixer$(SLASH)mixer.i $(EXTERNALIRQMIXERDIR)$(SLASH)Mixer$(SLASH)mixer_config.i
	$(ASM) $(ASMFLAGS_MINIMAL) -DBUILD_MIXER $< -o $@
...
$(PERFTESTDIR)$(SLASH)PerformanceTest.o: $(PERFTESTDIR)$(SLASH)PerformanceTest.asm $(PERFTESTDIR)$(SLASH)PerformanceTest.i $(SUPPORTDIR)$(SLASH)debug.i $(GFXDIR)$(SLASH)displaybuffers.i $(GFXDIR)$(SLASH)blitter.i $(GFXDIR)$(SLASH)copperlists.i $(GFXDIR)$(SLASH)font.i $(CONVERTERDIR)$(SLASH)converter.i $(DATADIR)$(SLASH)samples.i $(PERFTESTDIR)$(SLASH)Mixer$(SLASH)mixer.i $(PERFTESTDIR)$(SLASH)Mixer$(SLASH)mixer_config.i $(PERFTESTDIR)$(SLASH)Plugins$(SLASH)plugins.i $(PERFTESTDIR)$(SLASH)Mixer$(SLASH)mixer_wrapper.i $(PERFTESTDIR)$(SLASH)Plugins$(SLASH)plugins_wrapper.i
	$(ASM) $(ASMFLAGS_PERF) -DBUILD_DBUFFERS -DBUILD_MIXER_WRAPPER $< -o $@
